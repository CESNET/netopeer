...
<!--PATTERN netopeer-cfgnetopeer-->
	...
	<!--RULE -->
<axsl:template match="/nc:data/cfgnetopeer:netopeer/cfgnetopeer:modules/cfgnetopeer:module" priority="1001" mode="M4"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/nc:data/cfgnetopeer:netopeer/cfgnetopeer:modules/cfgnetopeer:module"/>

		<!--REPORT -->
<axsl:if test="preceding-sibling::cfgnetopeer:module[cfgnetopeer:module-name=current()/cfgnetopeer:module-name]"><svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="preceding-sibling::cfgnetopeer:module[cfgnetopeer:module-name=current()/cfgnetopeer:module-name]"><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>Duplicate key "cfgnetopeer:module-name"</svrl:text></svrl:successful-report></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template>

	<!--RULE -->
<axsl:template match="/nc:data/cfgnetopeer:netopeer/cfgnetopeer:modules/cfgnetopeer:module/cfgnetopeer:implemented-rpc" priority="1000" mode="M4"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/nc:data/cfgnetopeer:netopeer/cfgnetopeer:modules/cfgnetopeer:module/cfgnetopeer:implemented-rpc"/>

		<!--REPORT -->
<axsl:if test=". = preceding-sibling::cfgnetopeer:implemented-rpc"><svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test=". = preceding-sibling::cfgnetopeer:implemented-rpc"><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>Duplicate leaf-list entry "<axsl:text/><axsl:value-of select="."/><axsl:text/>".</svrl:text></svrl:successful-report></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template><axsl:template match="text()" priority="-1" mode="M4"/><axsl:template match="@*|node()" priority="-2" mode="M4"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template></axsl:stylesheet>
